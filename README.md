...
- [Building all-Go apps](https://github.com/sumup/mobile/app)
- [Building libraries for SDK apps](https://github.com/sumup/mobile/cmd/gobind)
...
[basic](https://github.com/sumup/mobile/example/basic)
and the [bind](https://github.com/sumup/mobile/example/bind) example apps.
