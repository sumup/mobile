...
func TestAndroidBuild(t *testing.T) {
	...
	cmdBuild.flag.Parse([]string{"github.com/sumup/mobile/example/basic"})
...
GOOS=android GOARCH=arm CC=$GOMOBILE/ndk-toolchains/arm/bin/arm-linux-androideabi-clang CXX=$GOMOBILE/ndk-toolchains/arm/bin/arm-linux-androideabi-clang++ CGO_ENABLED=1 GOARM=7 go build -tags tag1 -x -buildmode=c-shared -o $WORK/lib/armeabi-v7a/libbasic.so github.com/sumup/mobile/example/basic
`))
...
func TestRegexImportGolangXPackage(t *testing.T) {
	tests := []struct {
		...
		{"ffffffff t github.com/sumup/mobile", "github.com/sumup/mobile", 2},
		{"ffffffff t github.com/example/repo/vendor/github.com/sumup/mobile", "github.com/sumup/mobile", 2},
		{"ffffffff t github.com/example/github.com/sumup/mobile", "", 0},
